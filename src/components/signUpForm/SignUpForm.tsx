...
const RegisterForm: React.FC<RegisterFormProps> = ({ closeModal }) => {
  ...
  return (
    <div
      className={`reg-form-container ${isActive ? "active" : ""}`}
      id="container"
    >
        ...
        <form className="register-form">
          ...
          <div className="social-iconss">
            <a
              ...
              className="icon reg-form-container-a"
            >
          ...
          <span className="reg-form-span-text">
          ...
          />
          <button onClick={handleSignUp} className="reg-form-btn" type="submit">
            Sign Up
          </button>
      ...
      <div className="toggle-container">
        <div className="toggle">
          <div className="toggle-panel toggle-left">
            ...
            <button
              className="hidden reg-form-btn"
              id="login"
              onClick={() => handleSignInClick("teacher")}
            >
              Sign Up
            </button>
          </div>
