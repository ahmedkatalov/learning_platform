  ...
  return (
    <div className={styles.aboutus}>
      <div className={styles.maincontainer}>
        <h1 className={styles.aboutush1}>Добро пожаловать в нашу команду!</h1>

        <div className={`${styles.teamMember} ${openIndex === 0 ? styles.open : ''}`}>
          <h2 className={styles.aboutustitle} onClick={() => toggleOpen(0)}>Ахьмад</h2>
          <p className={`about-us-p-txt ${styles.description} ${openIndex === 0 ? styles.open : ''}`}>
        ...
        <div className={`${styles.teamMember} ${openIndex === 1 ? styles.open : ''}`}>
          <h2 className={styles.aboutustitle}  onClick={() => toggleOpen(1)}>Мадина</h2>
          <p className={`about-us-p-txt ${styles.description} ${openIndex === 1 ? styles.open : ''}`}>
        ...
        <div className={`${styles.teamMember} ${openIndex === 2 ? styles.open : ''}`}>
          <h2 className={styles.aboutustitle}  onClick={() => toggleOpen(2)}>Усман</h2>
          <p className={`about-us-p-txt ${styles.description} ${openIndex === 2 ? styles.open : ''}`}>
        ...
        <div className={`${styles.teamMember} ${openIndex === 3 ? styles.open : ''}`}>
          <h2 className={styles.aboutustitle}  onClick={() => toggleOpen(3)}>Марьяшка</h2>
          <p className={`about-us-p-txt ${styles.description} ${openIndex === 3 ? styles.open : ''}`}>
