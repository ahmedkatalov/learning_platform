...
const questions: Question[] = [
    ...
    },
    {
        ...
        options: ['Создание структуры веб-страницы', 'Оформление веб-страницы', 'Создание интерактивности', 'Обработка данных'],
        correctAnswer: 1,
    },
    {
        id: 5,
    ...
    {
        id: 6,
        question: 'Какие из методов массивов возвращают новый массив в результате своей работы?',
        options: ['map, filter, some', 'forEach, map, pop', 'filter, push, sort', 'filter, map, slice'],
        correctAnswer: 3,
    },{
        id: 7,
        question: 'Event loop - это...',
        options: ['Мезанизм контроля обработчиков событий на DOM-элементах', 'Механизм, определяющий в какой момент времени происходит визуальный рендер', 'Механизм контроля очереди вызова асинхронных операций', 'Механизм контроля событий, связанных с отправкой запросов на сервер и получения ответов'],
        correctAnswer: 2,
    },
    {
        id: 8,
        ...
        options: ['Да, так как у массивов одинаоковое содержимое', 'Нет, это два разных массивва с одинаковым содержимы', 'Мне плоха', 'Да, так как масиивы передаются в переменные по значению'],
        correctAnswer: 1,
    },
    {
        id: 10,
