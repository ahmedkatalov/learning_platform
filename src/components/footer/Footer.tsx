...
const Footer: FC = () => {
    ...
    const handleSubmit = (event: React.FormEvent) => {
        ...
        emailjs.send('service_hby7wge', 'template_xaosooz', templateParams, 'HYRJkuQm8-qoy22Ff')
            .then((response) => {
        ...
        <footer className="footer-container">
            <div className='footer-content'>
                ...
                <div className="footer-section contact">
                    ...
                    <ul>
                        <li className='f-contact-li'><i className="contact-li-i fas fa-phone-alt"></i> +7(928)783-68-00</li>
